    ...
    <aside aria-label="Partner websites" className="flex flex-col gap-1 bg-background md:flex-row">
      {partners.map(({ label, domain }) => (
        <a
          ...
          className="flex min-w-0 flex-1 flex-col items-center justify-center gap-1 bg-banner px-4 pt-5 pb-24 md:py-5 text-center font-sans text-banner-foreground transition-opacity hover:opacity-90 focus-visible:outline-2 focus-visible:outline-offset-[-4px] focus-visible:outline-banner-foreground"
        >
