...
const signals = [
  {
    ...
    note: "Locked out of your home, car, or business? Our rapid response team arrives fast with the tools to get you back inside safely.",
  },
  {
    date: "Licensed",
    title: "Commercial Security",
    note: "Full-service commercial locksmith solutions including door closers, lever handles, access control, and master key systems.",
  },
  {
    date: "Trusted",
    title: "Residential Locks",
    note: "From basic deadbolts to smart lock upgrades, we take pride in securing your home with quality hardware and expert installation.",
  },
  {
    date: "Certified",
    title: "Safe Services",
    note: "Gun safe delivery, installation, digital keypad upgrades, and expert positioning for maximum security in your home or business.",
  },
  {
    date: "Veteran",
    title: "Honest Pricing",
    note: "No hidden fees, no bait-and-switch. We fight the nationwide locksmith scam with transparent, flat-fee pricing on every job.",
  },
]
  ...
  return (
    <section id="signals" ref={sectionRef} className="relative py-32 pl-6 md:pl-28">
      ...
      <div ref={headerRef} className="mb-16 pr-6 md:pr-12">
        ...
        <div className="mt-4">
          <SplitFlapText text="WHAT WE DO" speed={40} />
        </div>
      </div>
