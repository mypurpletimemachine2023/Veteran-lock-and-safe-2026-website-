...
function SplitFlapTextInner({ text, className = "", speed = 50, sequenceWords = [] }: SplitFlapTextProps) {
  const [displayText, setDisplayText] = useState(sequenceWords.length > 0 ? sequenceWords[0] : text)
  ...
  // Auto-cycle through sequence words on mount
  useEffect(() => {
