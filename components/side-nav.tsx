...
export function SideNav() {
  ...
  return (
    <nav className="fixed left-0 top-20 bottom-0 z-40 w-16 md:w-20 hidden md:flex flex-col justify-center border-r border-border/30 bg-background/80 backdrop-blur-sm">
